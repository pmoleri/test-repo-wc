...
export default class DesignSystemsLanding extends LitElement {
  static styles = css`
    ...
    .buttonflatenabled-copy::part(base) {
      color: #000000FF;
    }
    .buttonflatenabled-copy-2::part(base) {
      color: #000000FF;
    }
    .buttonflatenabled-copy-3::part(base) {
      color: #000000FF;
    }
    .button_1::part(base) {
      color: #FFFFFFFF;
    ...
    return html`
      ...
      <div class="column-layout design-systems-landing">
        <div class="row-layout menu">
          ...
          <igc-button variant="flat" class="buttonflatenabled-copy">
            RESOURCES
            <igc-ripple></igc-ripple>
          </igc-button>
          <igc-button variant="flat" class="buttonflatenabled-copy-2">
            NEWS
            <igc-ripple></igc-ripple>
          </igc-button>
          <igc-button variant="flat" class="buttonflatenabled-copy-3">
            JOBS
            <igc-ripple></igc-ripple>
          </igc-button>
          <igc-button variant="fab" class="button_1">
